...
/Users/ben/repos/vpssvr/tests/bhyve -A -H -P -s 0:0,hostbridge -s 1:0,lpc  -s 2:0,virtio-net,tap204  -s 2:0,virtio-blk,/Users/ben/repos/vpssvr/tests//254 -l com1,/dev/nmdm204A -c 4 -m 512 878 &
